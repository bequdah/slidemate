...
export const ExplanationPane = ({ slideNumbers, textContentArray, allSlidesTexts, thumbnail, onClose }: ExplanationPaneProps) => {
    ...
    const { usageLeft, incrementUsage, tier, gamesLeft, incrementGameUsage } = useAuth();
    ...
    const handleStartGame = async () => {
        const success = await incrementGameUsage();
        if (success) {
            setShowGame(true);
        } else {
            // If failed, it means limit reached (only for free users)
    ...
    return (
        <>
            <div className="fixed inset-0 z-[80] overflow-hidden flex flex-col bg-[#020617] animate-in fade-in duration-500 font-sans">
                {/* Backdrop */}
                                    ...
                                    {!mode ? (
                                        ...
                                        <div className="flex flex-col items-center justify-center py-12 space-y-10 animate-in fade-in duration-700">
                                            ...
                                            <button
                                                ...
                                                className="group relative flex flex-col items-center gap-2 transition-all duration-500 animate-in zoom-in slide-in-from-bottom-4"
                                            >
